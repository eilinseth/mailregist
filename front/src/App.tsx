...
function App() {
  ...
  return (
    <div className='bg-gradient-to-b from-sky-100 to-indigo-300 min-h-screen flex justify-center items-center'>
    <div className='flex items-center flex-col md:w-1/2 lg:w-1/3 text-slate-600 gap-6 w-3/4 p-5 py-10 min-h-[80%] bg-cyan-50/60  '>
      ...
      <form className='flex flex-col font-semibold gap-5'>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <button className='bg-green-400 p-1 w-24 rounded-lg mx-auto text-slate-100 mt-2'>Submit</button>
      </form>
      <p className='-mb-5'>Already have account ? </p>
      <button className='bg-indigo-400 p-1 w-24 rounded-lg mx-auto font-semibold text-slate-100'>Login</button>
